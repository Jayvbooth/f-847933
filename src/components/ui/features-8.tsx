    ...
    return (
        <section className="bg-background py-16 md:py-32 relative overflow-hidden">
            ...
            <div className="absolute inset-0 overflow-hidden pointer-events-none">
                <div className="absolute top-20 left-10 w-1 h-1 bg-foreground/10 rounded-full animate-pulse" style={{ animationDelay: '0s', animationDuration: '3s' }}></div>
                <div className="absolute top-40 right-20 w-0.5 h-0.5 bg-foreground/15 rounded-full animate-pulse" style={{ animationDelay: '1s', animationDuration: '4s' }}></div>
                <div className="absolute bottom-32 left-1/4 w-1 h-1 bg-foreground/10 rounded-full animate-pulse" style={{ animationDelay: '2s', animationDuration: '5s' }}></div>
                <div className="absolute top-60 right-1/3 w-0.5 h-0.5 bg-foreground/20 rounded-full animate-pulse" style={{ animationDelay: '3s', animationDuration: '3.5s' }}></div>
                <div className="absolute bottom-20 right-10 w-1 h-1 bg-foreground/15 rounded-full animate-pulse" style={{ animationDelay: '4s', animationDuration: '4.5s' }}></div>
            </div>
                    ...
                    <div className="relative z-10 grid grid-cols-6 gap-3">
                        <Card className="relative col-span-full flex overflow-hidden lg:col-span-2 bg-card border-border">
                            <CardContent className="relative m-auto size-fit pt-6">
                                ...
                                <h2 className="mt-6 text-center text-3xl font-semibold text-foreground">Customizable</h2>
                            </CardContent>
                        </Card>
                        <Card className="relative col-span-full overflow-hidden sm:col-span-3 lg:col-span-2 bg-card border-border">
                            <CardContent className="pt-6">
                                <div className="relative mx-auto flex aspect-square size-32 rounded-full border border-border before:absolute before:-inset-2 before:rounded-full before:border before:border-border/50">
                                    <svg className="m-auto h-fit w-24 text-muted-foreground" viewBox="0 0 212 143" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path
                                    ...
                                    <svg className="text-muted-foreground w-full" viewBox="0 0 386 123" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <g clipPath="url(#clip0_0_106)">
                                            ...
                                            <path
                                                ...
                                                fill="currentColor"
                                            />
                                            <path className="text-muted-foreground" d="M3 72H209" stroke="currentColor" strokeWidth="6" strokeLinecap="round" />
                                            <defs>
                                                <linearGradient id="paint0_linear_0_1" x1="106.385" y1="1.34375" x2="106" y2="72" gradientUnits="userSpaceOnUse">
                                                    <stop stopColor="white" stopOpacity="0" />
                                                    <stop className="text-muted-foreground" offset="1" stopColor="currentColor" />
                                                </linearGradient>
                        ...
                        <Card className="relative col-span-full overflow-hidden lg:col-span-3 bg-card border-border">
                            <CardContent className="grid pt-6 sm:grid-cols-2">
                                <div className="relative z-10 flex flex-col justify-between space-y-12 lg:space-y-6">
                                    <div className="relative flex aspect-square size-12 rounded-full border border-border before:absolute before:-inset-2 before:rounded-full before:border before:border-border/50">
                                        <Shield className="m-auto size-5 text-foreground" strokeWidth={1} />
                                    </div>
                                    <div className="space-y-2">
                                        <h2 className="text-lg font-medium text-foreground transition">Advanced Security</h2>
                                        <p className="text-muted-foreground">Enterprise-grade security with end-to-end encryption and multi-factor authentication.</p>
                                    </div>
                                </div>
                                <div className="rounded-tl-(--radius) relative -mb-6 -mr-6 mt-6 h-fit border-l border-t border-border p-6 py-6 sm:ml-6">
                                    ...
                                    <svg className="w-full sm:w-[150%]" viewBox="0 0 366 231" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <defs>
                                            <linearGradient id="paint0_linear_0_705" x1="0.85108" y1="0.947876" x2="0.85108" y2="230.114" gradientUnits="userSpaceOnUse">
                                                <stop className="text-muted-foreground/20" stopColor="currentColor" />
                        ...
                        <Card className="relative col-span-full overflow-hidden lg:col-span-3 bg-card border-border">
                            <CardContent className="grid h-full pt-6 sm:grid-cols-2">
                                <div className="relative z-10 flex flex-col justify-between space-y-12 lg:space-y-6">
                                    <div className="relative flex aspect-square size-12 rounded-full border border-border before:absolute before:-inset-2 before:rounded-full before:border before:border-border/50">
                                        <Users className="m-auto size-6 text-foreground" strokeWidth={1} />
                                    </div>
                                    <div className="space-y-2">
                                        <h2 className="text-lg font-medium transition text-foreground">Team Collaboration</h2>
                                        <p className="text-muted-foreground">Built for teams with real-time collaboration, shared workspaces, and role-based access controls.</p>
                                    </div>
                                </div>
                                <div className="before:bg-border relative mt-6 before:absolute before:inset-0 before:mx-auto before:w-px sm:-my-6 sm:-mr-6">
                                    <div className="relative flex h-full flex-col justify-center space-y-6 py-6">
                                        <div className="relative flex w-[calc(50%+0.875rem)] items-center justify-end gap-2">
                                            <span className="block h-fit rounded border border-border bg-card px-2 py-1 text-xs shadow-sm text-foreground">Sarah M.</span>
                                            <div className="ring-background size-7 ring-4">
                                                <img className="size-full rounded-full" src="https://images.unsplash.com/photo-1494790108755-2616b612b47c?w=150&h=150&fit=crop&crop=face" alt="Team member" />
                                            </div>
                                        </div>
                                        <div className="relative ml-[calc(50%-1rem)] flex items-center gap-2">
                                            <div className="ring-background size-8 ring-4">
                                                <img className="size-full rounded-full" src="https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=150&h=150&fit=crop&crop=face" alt="Team member" />
                                            </div>
                                            <span className="block h-fit rounded border border-border bg-card px-2 py-1 text-xs shadow-sm text-foreground">Alex J.</span>
                                        </div>
                                        <div className="relative flex w-[calc(50%+0.875rem)] items-center justify-end gap-2">
                                            <span className="block h-fit rounded border border-border bg-card px-2 py-1 text-xs shadow-sm text-foreground">Maria K.</span>
                                            <div className="ring-background size-7 ring-4">
                                                <img className="size-full rounded-full" src="https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=150&h=150&fit=crop&crop=face" alt="Team member" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
